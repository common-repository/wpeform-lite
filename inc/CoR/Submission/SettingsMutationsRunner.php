...
/**
 * Run mutations from settings config registry. Call `run_mutation` method on
 * every registered `ISettings`. This should be fired before saving the data
 * on model.
 *
 * @package WPEForm\CoR\Submission
 */
class SettingsMutationsRunner extends Base {
	/**
	 * {@inheritDoc}
	 */
