...
/**
 * RangeGroup Element class. Range Group.
 *
 * Group of range elements.
 */
class RangeGroup extends Base {
	/**
	 * {@inheritDoc}
	 *
	 * @return array
	...
	public function get_definition() : array {
		return [
			'title' => __( 'Range Group', 'wp-eform' ),
			'description' => __( 'Group of range elements.', 'wp-eform' ),
			'container' => true,
			'category' => 'design',
		];
	}
	...
	public function get_generic_appearance_structure(): array {
		return [
			'title' => [
				'uses' => true,
				'default' => __( 'Range Group element', 'wp-eform' ),
			],
