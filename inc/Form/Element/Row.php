...
/**
 * Row Element class. Row Container.
 *
 * Can contain multiple columns with different width.
 */
class Row extends Base {
	...
	public function get_definition() : array {
		return [
			'title' => __( 'Row Container', 'wp-eform' ),
			'description' => __( 'Can contain multiple columns with different width.', 'wp-eform' ),
			'container' => true,
			'category' => 'design',
		];
	}
	...
	public function get_generic_appearance_structure(): array {
		return [
			'title' => [
				'uses' => true,
				'default' => __( 'Row Container element', 'wp-eform' ),
			],
		];
	}
