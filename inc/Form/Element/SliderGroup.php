...
/**
 * SliderGroup Element class. Slider Group.
 *
 * Group of slider elements.
 */
class SliderGroup extends Base {
	/**
	 * {@inheritDoc}
	 *
	 * @return array
	...
	public function get_definition() : array {
		return [
			'title' => __( 'Slider Group', 'wp-eform' ),
			'description' => __( 'Group of slider elements.', 'wp-eform' ),
			'container' => true,
			'category' => 'design',
		];
	}
	...
	public function get_generic_appearance_structure(): array {
		return [
			'title' => [
				'uses' => true,
				'default' => __( 'Slider Group element', 'wp-eform' ),
			],
