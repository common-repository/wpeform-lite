...
/**
 * Fields for ScorePercentageRedirectionItem.
 */
class ScorePercentageRedirectionItem extends Base {
	/**
	...
	public static function common_fields() {
		return [
			...
			// can be null, because it may come a point, when form has no score
			'scoreId' => Type::id(),
			'url' => Type::nonNull( Type::string() ),
			'from' => Type::nonNull( Type::float() ),
			'to' => Type::nonNull( Type::float() ),
		];
	}
}
