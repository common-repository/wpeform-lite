...
/**
 * Fields for Element -> Config -> Attributes.
 */
class ElementConfigAttributes extends Base {
	/**
	...
	public static function common_fields() {
		return [
			'prefilType' => Type::nonNull( Registry::get( 'prefilType', 'enum' ) ),
			'prefilParameter' => Type::nonNull( Type::string() ),
			'readonly' => Type::nonNull( Type::boolean() ),
			// for text input normal input would work
			// for Checkbox, Dropdown, we would pass comma separated values like
			// id1, id2 etc...
			'defaultValue' => Type::nonNull( Type::string() ),
		];
	}
}
