...
/**
 * Class to represent type `SubmissionStat`.
 *
 * @package WPEForm\GraphQL\Type
 */
class SubmissionStat extends ObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'SubmissionStatType',
			'fields' => [
				'submissions' => Type::nonNull( Type::int() ),
				'forms' => Type::nonNull( Type::int() ),
			],
		];
