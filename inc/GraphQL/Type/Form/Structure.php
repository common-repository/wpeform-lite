...
/**
 * A class to represent Form Structure `structure`.
 */
class Structure extends ObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormStructureType',
			'fields' => [
				'id' => Type::nonNull( Type::id() ),
				'config' => Type::nonNull( Registry::get( 'structureConfig', 'type/form' ) ),
