...
/**
 * Class for FormMetaDefinitionType
 */
class Definition extends ObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormMetaDefinitionType',
			'fields' => [
				'title' => Type::nonNull( Type::string() ),
				'description' => Type::nonNull( Type::string() ),
				'container' => Type::nonNull( Type::boolean() ),
				'category' => Type::nonNull(
					Registry::get( 'formElementCategory', 'enum' )
				),
			],
		];
