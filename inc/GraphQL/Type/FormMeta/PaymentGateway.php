...
/**
 * Class for FormMetaPaymentGatewayType
 */
class PaymentGateway extends ObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormMetaPaymentGatewayType',
			'fields' => [
				'id' => Type::nonNull( Type::id() ),
				'label' => Type::nonNull( Type::string() ),
				'supportsSubscription' => Type::nonNull( Type::boolean() ),
			],
		];
