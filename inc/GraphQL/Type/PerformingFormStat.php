...
/**
 * Class to represent type `PerformingFormStat`.
 *
 * @package WPEForm\GraphQL\Type
 */
class PerformingFormStat extends ObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'PerformingFormStatType',
			'fields' => [
				'formId' => Type::nonNull( Type::id() ),
				'formName' => Type::nonNull( Type::string() ),
				'viewCount' => Type::nonNull( Type::int() ),
				'submissionCount' => Type::nonNull( Type::int() ),
				'conversionRate' => Type::nonNull( Type::float() ),
			],
		];
