...
use WPEForm\Factory\Form\Config\Payments as PaymentsConfig;
...
/**
 * Class for FormPaymentsInput.
 */
class Payments extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormPaymentsInput',
			'fields' => TypeOrInputFromFields::create_input_fields(
				PaymentsConfig::get_registered_configs_field_vars(),
				'FormPayments'
			),
		];
