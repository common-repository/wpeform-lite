...
/**
 * Class for FormScoreDesignationInput
 */
class ScoreDesignation extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormScoreDesignationInput',
			'fields' => ScoreDesignationField::get_input_fields(),
		];
