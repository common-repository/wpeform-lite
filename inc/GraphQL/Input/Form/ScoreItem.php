...
use WPEForm\GraphQL\Field\Form\ScoreItem as ScoreItemField;
...
/**
 * Class for FormScoreItemInput
 */
class ScoreItem extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormScoreItemInput',
			'fields' => ScoreItemField::get_input_fields(),
		];
