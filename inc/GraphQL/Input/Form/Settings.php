...
use WPEForm\Factory\Form\Config\Settings as SettingsConfig;
...
/**
 * Class for FormSettingsInput.
 */
class Settings extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormSettingsInput',
			'fields' => TypeOrInputFromFields::create_input_fields(
				SettingsConfig::get_registered_configs_field_vars(),
				'FormSettings'
			),
		];
