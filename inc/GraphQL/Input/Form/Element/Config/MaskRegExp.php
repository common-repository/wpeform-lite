...
/**
 * Class for FormElementConfigMaskRegExpInput
 */
class MaskRegExp extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormElementConfigMaskRegExpInput',
			'fields' => [
				'id' => Type::nonNull( Type::id() ),
				'pattern' => Type::nonNull( Type::string() ),
				'caseSensitive' => Type::nonNull( Type::boolean() ),
			],
		];
