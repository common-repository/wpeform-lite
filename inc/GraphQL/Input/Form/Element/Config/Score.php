...
use WPEForm\GraphQL\Field\Form\ElementScore as ScoreField;
...
/**
 * Class for FormElementConfigScoreInput
 */
class Score extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormElementConfigScoreInput',
			'fields' => ScoreField::get_input_fields(),
		];
