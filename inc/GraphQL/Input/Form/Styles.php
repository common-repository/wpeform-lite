...
use WPEForm\Factory\Form\Config\Styles as StylesConfig;
...
/**
 * Class for FormStylesInput.
 */
class Styles extends InputObjectType {
	/**
	 * Create an instance.
	 */
	public function __construct() {
		$config = [
			'name' => 'FormStylesInput',
			'fields' => TypeOrInputFromFields::create_input_fields(
				StylesConfig::get_registered_configs_field_vars(),
				'FormStyles'
			),
		];
