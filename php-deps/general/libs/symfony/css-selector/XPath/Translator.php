...
namespace WPEForm\GeneralDeps\Symfony\Component\CssSelector\XPath;

use WPEForm\GeneralDeps\Symfony\Component\CssSelector\Exception\ExpressionErrorException;
use WPEForm\GeneralDeps\Symfony\Component\CssSelector\Node\FunctionNode;
use WPEForm\GeneralDeps\Symfony\Component\CssSelector\Node\NodeInterface;
use WPEForm\GeneralDeps\Symfony\Component\CssSelector\Node\SelectorNode;
use WPEForm\GeneralDeps\Symfony\Component\CssSelector\Parser\Parser;
...
class Translator implements TranslatorInterface
{
    ...
    public function addAttributeMatching(XPathExpr $xpath, string $operator, string $attribute, $value): XPathExpr
    {
        if (!isset($this->attributeMatchingTranslators[$operator])) {
            throw new ExpressionErrorException(sprintf('WPEForm_GeneralDeps_Attribute matcher operator "%s" not supported.', $operator));
        }
