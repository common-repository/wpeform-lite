...
use WPEForm\GeneralDeps\GraphQL\Language\AST\OperationTypeDefinitionNode;
 ...
 * $ast = WPEForm\GeneralDeps\GraphQL\Language\Parser::parse($query);
 * $printed = WPEForm\GeneralDeps\GraphQL\Language\Printer::doPrint($ast);
 * ```
 */
class Printer
{
