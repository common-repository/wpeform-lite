...
namespace WPEForm\GeneralDeps\GraphQL\Server;
...
use WPEForm\GeneralDeps\GraphQL\Validator\Rules\ValidationRule;
 ...
 * Usage example:
 *
 *     $config = WPEForm\GeneralDeps\GraphQL\Server\ServerConfig::create()
 *         ->setSchema($mySchema)
 *         ->setContext($myContext);
 *
 *     $server = new WPEForm\GeneralDeps\GraphQL\Server\StandardServer($config);
 */
class ServerConfig
{
    /**
