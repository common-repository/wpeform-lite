...
use WPEForm\GeneralDeps\GraphQL\Deferred;
 ...
 *       'name' => 'Address',
 *       'fields' => [
 *         'street' => [ 'type' => WPEForm\GeneralDeps\GraphQL\Type\Definition\Type::string() ],
 *         'number' => [ 'type' => WPEForm\GeneralDeps\GraphQL\Type\Definition\Type::int() ],
 *         'formatted' => [
 *           'type' => WPEForm\GeneralDeps\GraphQL\Type\Definition\Type::string(),
 ...
 *          return [
 *              'name' => ['type' => WPEForm\GeneralDeps\GraphQL\Type\Definition\Type::string() ],
